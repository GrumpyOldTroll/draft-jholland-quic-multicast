...
Each channel has an independent sequence number space.
...
The client also sends back acknowledgements of data packets received from joined channels with MC_CHANNEL_ACK ({{channel-ack-frame}}) frames.
